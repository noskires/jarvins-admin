...
export class EmployeesService {
  ...
  list(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/employee/list', params);
  }

  save(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/employee/save', params);
  }

  update(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/employee/update', params);
  }

  delete(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/employee/delete', params);
  }

  export(params: any): Observable<any> {
    return this.http.get(environment.API_URL+'api/v1/employee/export', {responseType: 'blob'});
  }
  ...
  centers(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/organization/center/select2', params);
  }

  divisions(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/organization/division/select2', params);
  }

  sections(params: any): Observable<any> {
    return this.http.post(environment.API_URL+'api/v1/organization/section/select2', params);
  }
